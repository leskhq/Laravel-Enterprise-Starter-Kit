...
class UsersController extends Controller
{
    ...
    {
        return trans('admin/users/general.audit-log.category');
    }
    ...
    static public function GetAuditMessage(Audit $audit)
    {
        ...
        switch ($methodName) {
            case "@index":
                $message = trans('admin/users/general.audit-log.msg-index');
                break;
            case "@create":
                $message = trans('admin/users/general.audit-log.msg-create');
                break;
            case "@store":
                $message = trans('admin/users/general.audit-log.msg-store');
                break;
            case "@edit":
                $message = trans('admin/users/general.audit-log.msg-edit');
                break;
            case "@update":
                $message = trans('admin/users/general.audit-log.msg-update');
                break;
            case "@show":
                $message = trans('admin/users/general.audit-log.msg-show');
                break;
            case "@getModalDelete":
                $message = trans('admin/users/general.audit-log.msg-get-modal-delete');
                break;
            case "@destroy":
                $message = trans('admin/users/general.audit-log.msg-destroy');
                break;
            case "@disable":
                $message = trans('admin/users/general.audit-log.msg-disable');
                break;
            case "@enable":
                $message = trans('admin/users/general.audit-log.msg-enable');
                break;
            case "@disableSelected":
                $message = trans('admin/users/general.audit-log.msg-disabled-selected');
                break;
            case "@enableSelected":
                $message = trans('admin/users/general.audit-log.msg-enabled-selected');
                break;
            default:
