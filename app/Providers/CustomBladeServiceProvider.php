...
class CustomBladeServiceProvider extends ServiceProvider
{
    ...
    private function bladeDirectives()
    {
        ...
        Blade::directive('userTimeZone', function($expression){
            ...
            $parms = Utils::splitBladeParameters($expression);
            $dateCode = $parms[0];

            return "<?php echo e(App\Libraries\Utils::userTimeZone({$dateCode})); ?>";
        });

        Blade::directive('userActionslinks', function($expression){

            return "<?php echo e(App\Libraries\Utils::userActionslinks({$expression})); ?>";
        });
