...
//            $this->command->info('Permission created: '. $perm->name);
         ...
         * with the permissions to create and assign.
         *
         * 3)  The third entry defines any extra permissions that must
         * be created, but that have not been assigned to any roles
         * yet.
         *
        ...
        $permAndRoles =
            [
                ...
                // Used to list extra permissions that are not yet assigned.
                'permissions' => [
//                    'core-extra-perm-0',
//                    'core-extra-perm-1',
//                    'core-extra-perm-2',
        ...
        foreach ($permAndRoles['roles'] as $roleName => $permSet)
        {
...
//                    $this->command->info('Assigned permission ['.$perm->name.'] to role ['.$role->name.'].');
        ...
        // Create extra permission that are not yet assigned.
        foreach ($permAndRoles['permissions'] as $permName)
        {
            $perm = $this->permission->firstOrCreate([
                'name'          => $permName,
