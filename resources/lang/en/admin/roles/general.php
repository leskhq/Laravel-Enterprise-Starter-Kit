...
return [
    ...
    'audit-log'           => [
        ...
        'msg-show'              => 'Accessed details of role.',
        'msg-create'            => 'Initiated creation of new role.',
        'msg-store'             => 'Created new role.',
        'msg-edit'              => 'Initiated edit of role.',
        'msg-update'            => 'Submitted edit of role.',
        'msg-get-modal-delete'  => 'Request delete role confirmation.',
        'msg-destroy'           => 'Deleted role.',
        'msg-enable'            => 'Enabled role.',
        'msg-disabled'          => 'Disabled role.',
        'msg-enabled-selected'  => 'Enabled multiple selected roles.',
        'msg-disabled-selected' => 'Disabled multiple selected roles.',
    ],
