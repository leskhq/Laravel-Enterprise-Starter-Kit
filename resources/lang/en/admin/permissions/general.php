...
return [
    ...
    'audit-log'           => [
        ...
        'msg-show'              => 'Accessed details of permission.',
        'msg-create'            => 'Initiated creation of new permission.',
        'msg-store'             => 'Created new permission.',
        'msg-edit'              => 'Initiated edit of permission.',
        'msg-update'            => 'Submitted edit of permission.',
        'msg-get-modal-delete'  => 'Request delete permission confirmation.',
        'msg-destroy'           => 'Deleted permission.',
        'msg-generate'          => 'Triggered generation of permissions based on routes.',
        'msg-enable'            => 'Enabled permission.',
        'msg-disabled'          => 'Disabled permission.',
        'msg-enabled-selected'  => 'Enabled multiple selected permissions.',
        'msg-disabled-selected' => 'Disabled multiple selected permissions.',
    ],
