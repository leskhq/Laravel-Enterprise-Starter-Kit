...
@section('content')
    <div class='row'>
        <div class='col-md-12'>
            <!-- Box -->
            {!! Form::open( ['url' => url('admin/errors?search=1'), 'id' => 'frmErrorList'] ) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h3 class="box-title">{{ trans('admin/users/general.page.index.table-title') }}</h3>
                                    ...
                                    @permission('core.p.errors.purge')
                                        <a class="btn btn-default btn-sm" href="{!! route('admin.errors.confirm-purge') !!}" data-toggle="modal" data-target="#modal_dialog" title="{{ trans('admin/errors/general.action.purge', ['purge_retention' => $purge_retention]) }}">
                                            <i class="fa fa-refresh"></i>
                                        </a>
                                    @else
                                        <a class="btn btn-default btn-sm" disabled="true"  href="#" title="{{ trans('admin/errors/general.action.no-permission-to-purge-errors') }}">
                                            <i class="fa fa-refresh"></i>
                                        </a>
                                    @endpermission
                            </div> <!-- col-sm-6 -->
                                ...
                                {!! $filter->open !!}
                                    <div class="input-group custom-search-form">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            <a href="{!! route('admin.errors.index') !!}" class="btn btn-default">
