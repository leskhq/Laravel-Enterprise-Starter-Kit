                        ...
                        @if( isset($sale) )
                            ...
                            @foreach( $sale->saleDetails as $key => $d )
                                <tr id="row{{ $d->id }}">
                                    ...
                                    <td>
                                        {!! Form::text('item['. $key .'][price]', $d->price, ['placeholder' => 'price', 'class' => 'form-control', 'id' => 'price'. $key .'']) !!}
                                    </td>
                                    <td>
                            ...
                            @for($x = $no; $x <=50; $x++)
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::text('item['. $x .'][price]', '', ['placeholder' => 'price', 'class' => 'form-control', 'id' => 'price'. $x .'']) !!}
                                    </td>
